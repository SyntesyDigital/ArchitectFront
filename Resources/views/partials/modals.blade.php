                        ...
                        <div class="modal-body sub-left-square">
                            <form id="loginModalForm" method="POST" action="{{ route('login') }}">
                                ...
                                <a href="{{ route('linkedin.login') }}">
                                    <img src="/modules/front/images/linkedin-signin.png" width="220" />
                                </a>
                                ...
                                <img class="loader" id="loginLoader" src="{{asset('modules/front/images/loader.gif')}}" />
                            </form>
                        </div>
                    </div>
                            ...
                            <form role="form" id="registerModalForm"  method="POST" action="">
                              {{ csrf_field() }}
                                <h3>VOUS N'AVEZ PAS DE COMPTE</h3>
                                    ...
                                    <input type="password" id="reg-password" name="password" value="" placeholder="Password" class="form-control" />
                                    @if ($errors->has('password'))
                                      <p class="control-label error-login-p">{{ $errors->first('password') }}</p>
                                    @endif

                                    <input type="password" id="reg-password_confirmation" name="password_confirmation" value="" placeholder="Confirmation du mot de passe" class="form-control" />
                                    @if ($errors->has('password_confirmation'))
                                      <p class="control-label error-login-p">{{ $errors->first('password_confirmation') }}</p>
                                    @endif
                                 ...
                                 @endif
                                  ...
                                  <img class="loader" id="regLoader" src="{{asset('modules/front/images/loader.gif')}}" />
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            <form role="form" method="POST" action="{{ route('login') }}">
                              {{ csrf_field() }}
                                ...
                                <img class="loader" id="enterpriseLoader" src="{{asset('modules/front/images/loader.gif')}}" />
                            </form>
                        </div>
                    </div>
                            ...
                            <form role="form" id="cv-form" method="POST" action="{{ route('candidate.addcv') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <img class="loader" id="upload-loader" src="{{asset('modules/front/images/loader.gif')}}" />
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                                <h3>Est vous sur de vouloir postuler?</h3>
                                 <div class="row">
                                    ...
                                    <img class="loader applyLoader" src="{{asset('modules/front/images/loader.gif')}}" />
                                </div>
                        </div>
                    </div>
                </div>
